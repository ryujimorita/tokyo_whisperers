...
\begin{figure*}[t]
    ...
    \end{subfigure}
    \caption{Training and evaluation metrics for Tiny (top row), Base (middle row), and Small (bottom row) models. From left to right: training loss, evaluation loss, training WER, and evaluation CER.}
